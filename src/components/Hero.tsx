        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="hidden md:block">
            <div className="relative">
              ...
              <img src="https://images.pexels.com/photos/4397835/pexels-photo-4397835.jpeg?auto=compress&cs=tinysrgb&w=600"
                   alt="Painel Solar" className="relative rounded-2xl shadow-2xl" />
            </div>
          </div>
        </div>
      </div>
